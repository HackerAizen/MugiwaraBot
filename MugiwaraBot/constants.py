...
BADWORDS =  ["лох", "дурак", "porn", "порн", "fuck", "hoe", "прон", "slave", "penis", "relig", "slave", "war ", "blood", 
            "traum", "violence", "weapon", "kill", "dynamite", "bomb", "death", "dead", "terror", "destroy", "drug",
            ...
            "нарко", "пизд", "уеб", "жоп", "даун", "идиот", "pidor", "пидор", "дур", "секс", "трах", "пенис", "член", "cum", "конч"]
LINKS = [".org", ".net", ".ru", ".shop", ".xyz", ".ру", ".рф"]

# Write Your Discord Bot Token Here
TOKEN = ''
PREFIX = '!'
